...
/**
 * This class is used for record keeping of student data
 * @author Peile Lin Tianxing Fan and Cheng Yang
 */
            ...
            for (List<String> studentData : studentsData) {
                if (studentData.get(0).equals(studentId)) {
                    ...
                    while (true) {
                        ...
                        System.out.println();
                        if (choice.equals("1")) {
                            viewStudentInfo(studentId, "./csv/studentInfo_course.csv");
                        } else if (choice.equals("2")) {
                            viewStudentGrades(studentId, "./csv/studentQCA.csv");
